...
from cogie.io.processor.ner.ace2005 import ACE2005W2NerProcessor
...
train_data, dev_data, test_data  = loader.load_all('../../../cognlp/data/ner/ace2005/data/')
print("Hello World!")

processor = ACE2005W2NerProcessor(
    label_list=loader.get_entity_labels(),
    padding="<pad>",unknown="<unkonwn>",path='../../../cognlp/data/ner/ace2005/data/',bert_model='bert-large-cased',max_length=512
)
...
trainer = cogie.Trainer(model,
                        ...
                        num_workers=5,
                        save_path="../../../cognlp/data/ner/ace2005/model",
                        save_file=None,
                        print_every=None,
                        scheduler_steps=1,
                        validate_steps=1000,
                        ...
                        callbacks=None,
                        metric_key=None,
                        writer_path='../../../cognlp/data/ner/ace2005/tensorboard',
                        fp16=False,
                        fp16_opt_level='O1',
                        # checkpoint_path="./checkpoint-1",
                        task='train',
                        logger_path='../../../cognlp/data/ner/ace2005/logger')
